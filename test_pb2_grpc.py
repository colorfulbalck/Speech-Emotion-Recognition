...
class MsgServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMsg = channel.unary_unary(
                '/MsgService/GetMsg',
                request_serializer=test__pb2.MsgRequest.SerializeToString,
                response_deserializer=test__pb2.MsgResponse.FromString,
                )
...
def add_MsgServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetMsg': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMsg,
                    request_deserializer=test__pb2.MsgRequest.FromString,
                    response_serializer=test__pb2.MsgResponse.SerializeToString,
            ),
    }
...
class MsgService(object):
    ...
    def GetMsg(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/MsgService/GetMsg',
            test__pb2.MsgRequest.SerializeToString,
            test__pb2.MsgResponse.FromString,
